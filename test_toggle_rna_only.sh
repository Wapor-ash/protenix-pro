#!/bin/bash
# =============================================================================
# Quick smoke test: RNA-only mode (use_dna_embed=False)
# Verifies that DNA embedding is skipped and no errors occur
# =============================================================================
set -euo pipefail
...
OUTPUT_DIR="${PROTENIX_DIR}/output/test_toggle_rna_only"
...
echo "========================================================"
echo "  TEST 2: RNA-only mode (use_dna_embed=False)"
echo "  separate_dna_projection=True (only rna_projection created)"
echo "========================================================"

python3 ./runner/train.py \
    --model_name "protenix_base_20250630_v1.0.0" \
    --run_name "test_toggle_rna_only" \
    --seed 42 \
    --base_dir "${OUTPUT_DIR}" \
    --dtype "bf16" \
...
echo ""
echo "TEST 2 PASSED: RNA-only mode works correctly"
echo ""
