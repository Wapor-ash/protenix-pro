#!/bin/bash
# =============================================================================
# Protenix + AIDO RNA/DNA LLM : Separate projections, INPUT injection
#
# Design:
...
#   - Injection at InputFeatureEmbedder (like ESM protein embedding)
...
OUTPUT_DIR="${PROTENIX_DIR}/output/aido_separate_input"
# ===========================================================
...
echo "========================================================"
echo "  Protenix + AIDO Separate RNA/DNA — INPUT Injection"
...
echo "AIDO separate RNA/DNA INPUT injection fine-tuning complete!"
