#!/bin/bash
# =============================================================================
# Protenix + AIDO RNA/DNA LLM : Separate projections, DIFFUSION injection
#
# Design:
...
#   - Injection at DiffusionConditioning (add to s_trunk)
#   - separate_dna_projection=True: independent projection layers, no zero-padding
# =============================================================================
set -euo pipefail
...
OUTPUT_DIR="${PROTENIX_DIR}/output/aido_separate_diffusion"
# ===========================================================
...
echo "AIDO separate RNA/DNA DIFFUSION injection fine-tuning complete!"
